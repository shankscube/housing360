...
Case-manager-facing care planning: the case detail Plan tab's care-plan/goal/task listing, the Care Plan wizard (create, edit, add-goal, edit-goal), service-gap detection against in-house benefits, and the ROI-gated Refer-to-Partner-Agency flow. Added by `case-workspace`.
