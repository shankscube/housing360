...
Case-manager-facing service delivery: the case detail Services tab's enrollment/service/disbursement listing, assigning services from the program's configured benefits, recording disbursements, and bed assignment/daily-log tracking. Added by `case-workspace`.
